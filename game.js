...
export const CONFIG = {"title":"香火長明","genre":"放置經營","visual":"idle","accent":"#f4c95d","actions":{"tap":"添一炷香","generator":"建造香爐","upgrade":"升級法會","prestige":"重修金身"},"help":"香爐自動產生香火，升級法會提高倍率。離線收益依 KV 儲存時間估算，重修金身取得永久加成。","test":["tap","tap","tap","generator","tap","tap","upgrade","tap","prestige"],"id":"pg-templeidle"};
